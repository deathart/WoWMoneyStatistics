...
mt.RegisterTracker(VOID_STORAGE_UUID, 'VOID', 'VOID_STORAGE_UPDATE', 'VOID_STORAGE_UPDATE', OnTrigger)
mt.RegisterTracker(AZERITE_REFORGE_UUID, 'AZERITEREFORGE', 'AZERITE_EMPOWERED_ITEM_SELECTION_UPDATED', 'AZERITE_EMPOWERED_ITEM_SELECTION_UPDATED', OnTrigger)
